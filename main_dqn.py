...
if __name__ == '__main__':
    ...
    A =  cart_agent(epsilon=1,eps_decay=0.005,epsilon_min=0.01,gamma=0.99,l_r=0.0001,input_dims=4,n_actions=2,
    ...
    for i in range(n_games):
        ...
        if avg_score[-1] > best_score:
            torch.save(A.policy_net.state_dict(),'/home/raj/My_projects/DQN/CartPole.pt')
