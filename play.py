...
if __name__ == '__main__':
    player =  cart_agent(epsilon=0,eps_decay=0,epsilon_min=0,gamma=0,l_r=0,input_dims=4,n_actions=2,
                memory=0,batch_size=0,target_update=0,env = env,save = True)
    n_games = 3
    scores = []
    player.policy_net.load_state_dict(torch.load('/home/raj/My_projects/DQN/CartPole.pt'))
